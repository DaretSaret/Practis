...
Возникшие трудности: проблема с новым форматом api запроса (https://api.openweathermap.org/data/3.0/onecall?lat={lat}&lon={lon}&exclude={part}&appid={API key}), при использовании координатов lat и lon возникает ошибка при проверке  api ключа.
